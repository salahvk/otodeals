...
postChangepasswordData(BuildContext context) async {
  final currentpassword =
      Changepasswordcontoller.currentpasswordController.text;
  final newpassword = Changepasswordcontoller.newpasswordController.text;
  final confirmpassword =
      Changepasswordcontoller.confirmpasswordController.text;
  String url =
      "${ApiEndpoint.changepassword}?newpassword=$newpassword&confirmpassword=$confirmpassword&currentpassword=$currentpassword";
  String s = 'abc';
  String? token;
  ...
  try {
    ...
    if (storedpassword !=
      ...
      showAnimatedSnackBar(context, "your password changed",
