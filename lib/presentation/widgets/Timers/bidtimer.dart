...
class BidtimerScreen extends StatefulWidget {
   final int? index;
  const BidtimerScreen({this.index,super.key});

  @override
  State<BidtimerScreen> createState() => _BidtimerScreenState();
}

class _BidtimerScreenState extends State<BidtimerScreen> {
  ...
  void initState() {
   final res=Provider.of<Bidprovider>(context,listen:false);
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) async {
      ...
      DateTime startTime = dateFormat.parse(res.bidvar?.bidHistory![widget.index!].starttime ??DateTime.now().toString());
      DateTime endTime = dateFormat.parse(res.bidvar?.bidHistory![widget.index!].endtime??DateTime.now().toString());
