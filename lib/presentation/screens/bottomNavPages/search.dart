...
class _searchsState extends State<searchs> {
  ...
  Future<void> _fetchSearchResults() async {
    SearchFilters filters = SearchFilters(
        fuelType: Searchcontroller.fueltypecontroller.text,
        gearshift: Searchcontroller.gearshiftcontroller.text,
        type: Searchcontroller.vehicletypecontroller.text,
        modelyear: Searchcontroller.modelyearcontroller.text,
        maxPrice: Searchcontroller.maxpricecontroller.text,
        minPrice: Searchcontroller.minpricecontroller.text);
    final url =
        ApiEndpoint.vehiclelisting; // Replace with your actual web service URL
    print(url);
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      decoration: const BoxDecoration(
                        color: Color.fromARGB(255, 169, 20, 20),
