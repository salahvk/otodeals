                          ...
                          child: TextField(
                            decoration: InputDecoration(
                              ...
                              hintStyle: getSemiBoldStyle(
                                  fontSize: 14, color: Colormanager.greyText),
                          ...
                          Padding(
                            ...
                            child: Container(
                              ...
                              child: Icon(Icons.arrow_forward_ios_rounded,
                                  size: 15, color: Colormanager.primary),
                            ),
                          ),
                        ],
                      ),
                                ...
                                Center(
                                  child: Container(
                                      ...
                                      decoration: BoxDecoration(
                                          ...
                                          color: Colormanager.white),
                                      child: Image.asset(
                                        "assets/pngkit_subscribe-button-png_49494.png",
                                        color: Colormanager.primary,
                                        height: 1,
                                        width: 1,
                                        fit: BoxFit.contain,
                                ...
                                Center(
                                  child: Container(
                                      ...
                                      decoration: BoxDecoration(
                                          ...
                                          color: Colormanager.white),
                                      child: Image.asset(
                                        'assets/NicePng_handshake-png_297406.png',
                                        color: Color.fromARGB(255, 180, 15, 26),
                                      )),
                                )
                              ],
                            ),
