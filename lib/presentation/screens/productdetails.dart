  ...
  void _showvehicleparts() {
    showDialog(
        ...
        builder: (BuildContext context) {
          final vres =
              Provider.of<Vehicledetailsprovider>(context, listen: true);
          return Dialog(
                ...
                child: Column(children: [
                  ...
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        DetailCard(
                            text:
                                "${vres.vehdet?.vehicle?.fueltype.toString()}"),
                        DetailCard(
                            text:
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      DetailCard(
                          text:
                              "${vres.vehdet?.vehicle?.gearshift.toString()}"),
                      DetailCard(
