      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              "Please Subscribe Validity Package To \nContinue",
                    ...
                    return Padding(
                      ...
                      child: Container(
                        ...
                        child: Row(
                          ...
                          children: [
                            Text(
                              "${payres.paydata?.paymentDetails![index].displayName ?? ""}\t:",
                            ...
                            Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                Text(payres.paydata?.paymentDetails![index]
                                        .value ??
                                    ""),
                              ],
                            )
            ...
            Text(
              "Payment Amount",
              style:
                  getMediumtStyle(color: Colormanager.textColor, fontSize: 14),
            ),
            SizedBox(
            ...
            Text(
              "Pay your amount to above bank account",
              style:
                  getMediumtStyle(color: Colormanager.greyText, fontSize: 11.5),
            ),
            SizedBox(
              height: size.height * .06,
            ),
            Text(
              "Upload Pay Slip Or Screenshot",
              style: getSemiBoldStyle(color: Colormanager.black, fontSize: 16),
            ),
            SizedBox(
              height: size.height * .02,
