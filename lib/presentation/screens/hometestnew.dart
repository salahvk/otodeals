...
//                                 children: [
//                                  Text("Drive Your",style: getMediumtStyle(color:const Color.fromARGB(255, 0, 0, 0),fontSize:20),),
//                                     Row(
//                                       children: [
//                                         Text("Dreams",style: getMediumtStyle(color:Colormanager.primary,fontSize:20),),
//                                             SizedBox(width:8,),
...
//                               ),
//                             ),
//                             Image.asset("assets/oto.jpg",height:80,width:130,)
//                           ],
//                         )
//                       ],
//                     ),
...
//                               height: 50,
//                               width: size.width/2,
//                               child: Center(child: Text("LIVE",style: getSemiBoldStyle(color: Colormanager.black,fontSize:15),)),
//                             ),
//                             SizedBox(
//                               height: 50,
//                               width:size.width/2.12,
//                               child: Center(child: Text("UPCOMING",style: getSemiBoldStyle(color: Colormanager.black,fontSize:15),)),
//                             )
//                           ],
//                          ),
